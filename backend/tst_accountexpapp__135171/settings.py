"""
Django settings for tst_accountexpapp__135171 project.
...
ROOT_URLCONF = 'tst_accountexpapp__135171.urls'
...
WSGI_APPLICATION = 'tst_accountexpapp__135171.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_accountexpapp__135171 API",
    "DESCRIPTION": "API documentation for tst_accountexpapp__135171 App",
    "VERSION": "v1",
}
